...
<link href="web/css/manager.css" rel="stylesheet" type="text/css" />
<style>
img {
	width: 200px;
	height: 120px;
...
<body>
	<div class="container">
		<div class="table-wrapper">
				...
				<tbody>
					<c:forEach items="${listP}" var="o">
						<tr>
							...
							<td>${o.price}$</td>
							<td><a href="load?pid=${o.id}" class="edit"
			...
			<div class="clearfix">
				<div class="hint-text">
					Showing <b> 3</b> out of <b>${listSize}</b> entries
				</div>
				<ul class="pagination">
					<c:if test="${tag >1}">
					...
					<c:forEach begin="1" end="${endP}" var="o">
						<li class="page-item ${tag== o? "active" :"null" }"><a
							href="manager?index=${o}" class="page-link">${o}</a></li>
					</c:forEach>
					<c:if test="${tag < endP}">
	...
	<script src="web/js/manager.js" type="text/javascript"></script>
</body>
</html>